---
layout: post
title: "Firefox Hardening Guide 2026"
date: 2026-01-02
---

Tested on Firefox 146.0.1
...
* `[DEFAULT: true/false]`       - Specifies the existing default value.

_**NOTE**: Settings that specify values equal (redundant) to the defaults are not listed (with some exceptions for clarity)._

For further information, please read here: [arkenfox's user.js](https://github.com/arkenfox/user.js).
...
### Networ: DNS, Proxy, Network Checks
...
* Set "Time range to clear" for "Clear Data" (2820+) and "Clear History":
    ...
    * 3 = last four hours
    * 4 = today
    * NOTE: Values 5 (last 5 minutes) and 6 (last 24 hours) are not listed in the dropwdown
